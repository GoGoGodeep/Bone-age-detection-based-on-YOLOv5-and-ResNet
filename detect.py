...
def run(
        weights=ROOT / 'yolov5s.pt',  # 模型权重
        source=ROOT / 'data/images',  # file/dir/URL/glob/screen/0(webcam)
        data=ROOT / 'data/bone.yaml',  # dataset.yaml path
...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/bone.yaml', help='(optional) dataset.yaml path')
